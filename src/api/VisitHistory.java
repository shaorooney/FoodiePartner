...
public class VisitHistory extends HttpServlet {
	 ...
	 *      response)
	 */
	// return a list of restaurants that the user has visited
	 ...
	 *      response)
	 */
	// input user_id, and business_id, put the result into database
	...
	// front end call VisitoryHistory API and unset the visited history
