...
public class RestaurantTest {
	...
	@Test
	public void testJsonArrayToString() {// 测试JSON convert to String
		// (1) good input test
	...
	@Test
	public void testJsonArrayToStringCornerCases() {// (2) corner case test
		JSONArray jsonArray = new JSONArray();
	...
	@After
	public void tearDown() { //inner method: print test method's name
